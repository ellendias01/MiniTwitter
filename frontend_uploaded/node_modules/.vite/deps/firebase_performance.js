...
function getServiceWorkerStatus() {
  ...
  if (navigator2 == null ? void 0 : navigator2.serviceWorker) {
...
function getAppId(firebaseApp) {
  var _a;
  const appId = (_a = firebaseApp.options) == null ? void 0 : _a.appId;
  if (!appId) {
    throw ERROR_FACTORY.create(
      "no app id"
      /* ErrorCode.NO_APP_ID */
...
function getProjectId(firebaseApp) {
  var _a;
  const projectId = (_a = firebaseApp.options) == null ? void 0 : _a.projectId;
  if (!projectId) {
    throw ERROR_FACTORY.create(
      "no project id"
      /* ErrorCode.NO_PROJECT_ID */
...
function getApiKey(firebaseApp) {
  var _a;
  const apiKey = (_a = firebaseApp.options) == null ? void 0 : _a.apiKey;
  if (!apiKey) {
    throw ERROR_FACTORY.create(
      "no api key"
      /* ErrorCode.NO_API_KEY */
...
function setupOobTraces(performanceController) {
  ...
  api.onLCP((metric) => {
    ...
    webVitalMetrics.lcp = {
      value: metric.value,
      elementAttribution: (_a = metric.attribution) == null ? void 0 : _a.element
    };
  });
  api.onCLS((metric) => {
    var _a;
    webVitalMetrics.cls = {
      value: metric.value,
      elementAttribution: (_a = metric.attribution) == null ? void 0 : _a.largestShiftTarget
    };
  });
  api.onINP((metric) => {
    var _a;
    webVitalMetrics.inp = {
      value: metric.value,
      elementAttribution: (_a = metric.attribution) == null ? void 0 : _a.interactionTarget
    };
  });
}
...
var PerformanceController = class {
  ...
  _init(settings) {
    ...
    if ((settings == null ? void 0 : settings.dataCollectionEnabled) !== void 0) {
      this.dataCollectionEnabled = settings.dataCollectionEnabled;
    }
    if ((settings == null ? void 0 : settings.instrumentationEnabled) !== void 0) {
